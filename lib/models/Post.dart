...
class Post extends amplify_core.Model {
  ...
  Post copyWith({String? title, PostStatus? status, int? rating, String? content}) {
    return Post._internal(
      id: id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'title': _title, 'status': amplify_core.enumToString(_status), 'rating': _rating, 'content': _content, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
